...
insert into tb_restaurante (id_restaurante, nm_restaurante, taxa_frete, id_cozinha, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro) values (1, 'Thai Gourmet', 10, 1, 1, '38400-999', 'Rua João Pinheiro', '1000', 'Centro');
